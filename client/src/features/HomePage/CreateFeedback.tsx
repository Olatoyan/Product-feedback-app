        ...
        <div className="space-y-[2.4rem] pt-16 tablet:pt-[2.4rem]">
          <div>
            ...
            <input
              type="text"
              id="title"
              className={`w-full rounded-[0.5rem] border border-solid outline-none bg-[#f7f8fd] px-[2.4rem] py-[1.2rem] text-[1.5rem] text-[#3a4374] tablet:text-[1.3rem] ${errors?.title?.message ? "border-[#d73737] focus:border-[#d73737] focus:outline-[#d73737]" : "border-transparent focus:border-[#4661e6] focus:outline-[#4661e6]"}`}
              {...register("title", {
          ...
          <div>
            ...
            <textarea
              id="detail"
              rows={4}
              className={`w-full resize-none rounded-[0.5rem] border border-solid bg-[#f7f8fd] px-[2.4rem] py-[1.2rem] outline-none text-[1.5rem] text-[#3a4374] tablet:text-[1.3rem] ${errors?.detail?.message ? "border-[#d73737] focus:border-[#d73737] focus:outline-[#d73737]" : "border-transparent focus:border-[#4661e6] focus:outline-[#4661e6]"}`}
              {...register("detail", {
                required: "Can't be empty",
                minLength: {
                  value: 3,
